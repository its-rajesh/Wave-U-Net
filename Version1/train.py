...
def main(args):
    ...
    #print(train_data)
    #print('__________:', len(train_data))
...
if __name__ == '__main__':
    ## TRAIN PARAMETERS
    parser = argparse.ArgumentParser() #['mridangam_left', 'mridangam_right', 'violin', 'vocal']
    parser.add_argument('--instruments', type=str, nargs='+', default=["mridangam_left", "mridangam_right", "violin", "vocal"],
