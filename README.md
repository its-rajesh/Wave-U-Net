...
> MUSDB18HQ is internally artificially bleeded to evaluate the performance on the effect of leakage. Source is maintained dominant and other sources is bleeded to it with a volume reduction of 20dB. Trained on [PyTorch: Wave-U-Net](https://github.com/f90/Wave-U-Net-Pytorch) network.
